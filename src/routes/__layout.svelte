...
>
	...
	<div class="bg-gray-900 rounded-2xl mb-3 relative z-10 text-white">
		<div class="px-6 md:px-10 py-6 flex flex-col justify-center relative">
			<div class="relative md:absolute md:inset-x-10 w-full md:w-auto flex items-center justify-between">
      ...
      <div class="bg-gray-800 block md:hidden h-px my-5 -mx-6"></div>

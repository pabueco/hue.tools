...
<div class="xl:grid grid-cols-4 gap-10 container mx-auto">
  ...
  <div class="col-span-2 my-10 xl:my-0">
    ...
    <div class="grid grid-cols-2 gap-5 gap-y-8">
      ...
      <Modifier name="Darken" bind:value={darkenValue}>
        <div slot="description">Decrease the brightness</div>
      </Modifier>
      <Modifier name="Tint" bind:value={tintValue}>
        <div slot="description">Mix with pure white</div>
      </Modifier>
      <Modifier name="Shade" bind:value={shadeValue}>
        <div slot="description">Mix with pure black</div>
      </Modifier>
      <Modifier name="Desaturate" bind:value={desaturateValue}>
        <div slot="description">Decrease the saturation</div>
      </Modifier>
      <Modifier name="Saturate" bind:value={saturateValue}>
        <div slot="description">Increase the saturation</div>
      </Modifier>
      <Modifier name="Lighten" bind:value={lightenValue}>
        <div slot="description">Increase the luminance</div>
      </Modifier>
      <Modifier name="Spin" bind:value={spinValue} sliderProps={{range:{min:-360, max: 360}, connect: false}} unit="°">

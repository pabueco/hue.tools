...
<Fieldset label={name}>
  <div class="flex justify-between">
    ...
    <div class="flex items-end -mt-2.5">
      <input class="tabular-nums text-[1.6rem] leading-none font-normal font-mono bg-transparent border-none inline-block w-20 text-right mr-1 focus:outline-none relative top-[-1px]" value={value} on:input={onInput} />
      {#if unit}
